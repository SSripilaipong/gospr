...
parser/
  types.go            AST: ElemType{Kind,Elem,Inner,Fields} (ElemKind = KindStruct|KindVector(Elem token or Inner inline struct)|KindElemRef(`V.Elem` alias)), Expr sum type (ExprKind incl. StrLit/Guards), GuardCase, ValType, RefKind, TypeDef/FnDef/MergeDef/QueryDef/UpdateDef/CollectionSpec, Plan
